...
# Convert df_est$user_id to numeric
df_est$user_id <- as.integer(as.character(df_est$user_id))
df_est$first_rcid <- as.integer(as.character(df_est$first_rcid))
df_est$year <- as.integer(as.character(df_est$year))
